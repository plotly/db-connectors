...
const CONNECTION_CONFIG = {
    [DIALECTS.APACHE_DRILL]: APACHE_DRILL_ATTRIBUTES_SCHEMA,
    [DIALECTS.APACHE_IMPALA]: HADOOP_ATTRIBUTES_SCHEMA,
    [DIALECTS.APACHE_SPARK]: HADOOP_ATTRIBUTES_SCHEMA,
    [DIALECTS.ATHENA]: ATHENA_ATTRIBUTES_SCHEMA,
    [DIALECTS.BIGQUERY]: BIGQUERY_ATTRIBUTES_SCHEMA,
    [DIALECTS.CSV]: CSV_ATTRIBUTES_SCHEMA,
    [DIALECTS.DATA_WORLD]: DATAWORLD_ATTRIBUTES_SCHEMA,
    [DIALECTS.ELASTICSEARCH]: ELASTICSEARCH_ATTRIBUTES_SCHEMA,
    [DIALECTS.IBM_DB2]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.MARIADB]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.MYSQL]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.MSSQL]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.ORACLE]: ORACLE_ATTRIBUTES_SCHEMA,
    [DIALECTS.POSTGRES]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.REDSHIFT]: SQL_ATTRIBUTES_SCHEMA,
    [DIALECTS.SQLITE]: SQLITE_ATTRIBUTES_SCHEMA,
    [DIALECTS.S3]: S3_ATTRIBUTES_SCHEMA
};
