...
/**
 * The following method will connect to database
 * @param {object} connection
 * @param {string} connection.username
 * @param {string} connection.password
 * @param {string} connection.database
 * @param {string} connection.port
 * @param {string} connection.dialect
 * @param {string} connection.storage
 * @param {string} connection.host
 * @param {string} connection.ssl
 * @returns
 */
...
/**
 * The following method will execute the query string
 * @param {string} queryString Query String
 * @param {object} connection Connection parameters
 * @returns {object} contains arrays of rows and column names
 */
 ...
 * @param {object} connection Connection Parameters
 * @param {string} connection.dialect Dialect
 * @returns {object} contains arrays table names
 */
...
/**
 * Will obtain the schema information for the database
 * @param {object} connection Connection parameters
 * @param {object} connection.database database parameters
 * @param {string} connection.dialect Dialect Type
 * @returns {object} contains arrays table, column and type
 */
